...
<body>
	...
	<aside class="sidebar">
		<div>
			...
			<!-- 검색 끝 부분 -->
			<!-- 즐겨찾기 이동 -->
			<div id="markDiv" class="hide" style="height: 500px;">
				<div>
					<h3>즐겨찾기 목록</h3>
			...
			<!-- 최근검색 이동 -->
			<div id="rsrDiv" class="hide" style="height: 500px; overflow: auto;">
				<div>
					<h3>최근검색 목록</h3>
		...
		function selectFoodMark(nowPage){
			...
			$.ajax({
	     	        ...
	     	        success: function(result){
	     	        	$(".pagination").empty();
	     	        	console.log(result[0].vo.nowPage+"g");
	     	        	...
	     	        	for ( var i in result ) {
			        		$btr = $(`
									...
									<tr>
										...
										<th colspan="2">`+result[i].bookmark_date+`</th>
									</tr>
									<tr>
